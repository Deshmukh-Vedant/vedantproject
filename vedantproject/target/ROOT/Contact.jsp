        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Catagory</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="Marriage.jsp"><span>Marriage</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                ...
                <li><a href="Signup.jsp">SignUp</a></li>
		          ...
		          <li><a href="Aboutsignup.jsp">About</a></li>
		          <li><a href="Conatactsignup.jsp" class="active">Contact</a></li>
        </ul>
      </nav><!-- .navbar -->
